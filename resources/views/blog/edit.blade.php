...
<div class="w-4/5 m-auto pt-20">
    ...
    @csrf
    @method('PUT')
    <!-- PUT es para actualizar datos actuales y transferirá el
    metodo POST (datos actuales) que hemos agregado a nuestro form
    para la request PUT-->

    <!-- Se cambia placeholder en el input por value -->
